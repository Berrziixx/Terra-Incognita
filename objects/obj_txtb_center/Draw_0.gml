...
// exact screen center
textbox_x = cam_x + (cam_w - textbox_width) * 0.5;
textbox_y = cam_y + (cam_h - textbox_height) * 0.5;
...
// DRAW BOX (NO OFFSET = PERFECT CENTER)
draw_sprite_ext(
    txtb_spr,
    txtb_img,
    textbox_x,
...
var tx = start_x;   // renamed from x
var ty = start_y;   // renamed from y
